...
const PayType: FC<PropsType> = ({ list, label, onInputChange, onSelectChange, onAdd, onRemove }) => {
            ...
            <div className="label">{label}</div>
            {
                list.map((v: any, index: number) =>
                    <RowWrap key={index}>
                        ...
                        ></Select>
                        <TextInput value={v.address} placeholder='请输入' onChange={(e) => onInputChange(e.target.value, index)} className='input'></TextInput>
